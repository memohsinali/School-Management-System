<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="School_Management.LoginPage" %>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rvftxtuserName" runat="server" ControlToValidate="txtUserName"
                                ErrorMessage="Please Enter UserName." Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
