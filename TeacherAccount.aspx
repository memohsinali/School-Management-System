<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherAccount.aspx.cs" Inherits="School_Management.TeacherAccount" %>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTeacherCode" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rvfTeacherCode" runat="server" ControlToValidate="txtTeacherCode"
                                ErrorMessage="Please enter Teacher Code." Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
